...
Using Spark: Using the input of tweets.txt, perform WordCount after Removing StopWords,
    Removing special characters and Filtering words whose length is more than or equal to four characters, 
